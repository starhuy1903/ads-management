    ...
    <DetailWrapper label="Create Panel Licensing Request">
      ...
      <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
        ...
        <FormControl fullWidth>
          ...
          <ReadOnlyTextField
            value={rows.find((row) => row.id === formValue.locationId)?.commue}
            disabled
          />
        </FormControl>
      ...
      <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
        <FormControl fullWidth>
          ...
          <ReadOnlyTextField
            value={
              rows.find((row) => row.id === formValue.locationId)?.positionType
            }
            disabled
          />
        </FormControl>
        ...
        <FormControl fullWidth>
          ...
          <ReadOnlyTextField
            value={rows.find((row) => row.id === formValue.locationId)?.adsType}
            disabled
          />
        </FormControl>
      </Stack>
