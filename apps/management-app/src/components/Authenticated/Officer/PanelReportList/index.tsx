...
import { CreatedPanelReport, CreatedReport } from '@/types/report';
                    ...
                    return (
                      <TableRow key={report?.id}>
                        ...
                        <TableCell align="center">
                          {report?.panel?.location?.name}
                        </TableCell>
                        <TableCell align="center">
                          {report?.panel?.location?.fullAddress}
                        </TableCell>
                        <TableCell align="center">
                          {report?.panel?.location?.ward?.name}
                        </TableCell>
                        <TableCell align="center">
                          {report?.panel?.location?.district?.name}
                        </TableCell>
                        <TableCell align="center">
